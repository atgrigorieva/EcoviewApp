    ...
    render(){
        return(
            <Container>
                            ...
                            <View style={{flex:1, flexDirection: 'row'}}>
                                <View style={{
                                    ...
                                    <Text style={{
                                        ...
                                        Переведите тумблер в положение «Включено». Для этого нажмите на сегмент с цифрой «1».
                                    </Text>

                                </View>
                                <View style={{marginLeft: 20}}>
                                    <Image
                                        source={require('../../img/B1200/tyl4_1.png')}/>
                                </View>
                            </View>
                        </View>
                    </View>
                ...
                <Footer>
                    <Left>
                        <Button transparent onPress={() => this.props.navigation.navigate('PowerConnectionStep5')}>
                            <Text>Назад</Text>
                        </Button>
                    </Left>
                    <Body><Button onPress={() => this.props.navigation.navigate('SystemInitialization')}><Text>Инициализация системы</Text></Button></Body>
