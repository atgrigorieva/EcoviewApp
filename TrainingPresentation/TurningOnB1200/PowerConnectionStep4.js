    ...
    render(){
        return(
            <Container>
                ...
                <Footer>
                    <Left>
                        <Button transparent onPress={() => this.props.navigation.navigate('PowerConnectionStep3')}>
                            <Text>Назад</Text>
                        </Button>
                    </Left>
                    <Body><Button onPress={() => this.props.navigation.navigate('PowerConnectionStep5')}><Text>Шаг 5</Text></Button></Body>
