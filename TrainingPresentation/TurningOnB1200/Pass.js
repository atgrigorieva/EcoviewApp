    ...
    render(){
        return(
            <Container>
                ...
                <Footer>
                    <Left>
                        <Button transparent onPress={() => this.props.navigation.navigate('NextPage2')}>
                            <Text>Назад</Text>
                        </Button>
                    </Left>
                    <Body><Button onPress={() => this.props.navigation.navigate('Remembered')}><Text>Я запомнил (а)</Text></Button></Body>
