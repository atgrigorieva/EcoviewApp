    ...
    render(){
        return(
            <Container>
                            ...
                            <View style={{flex:1, flexDirection: 'row'}}>
                                <View style={{
                                    ...
                                    <Text style={{
                                        fontSize:15,
                                        marginBottom: 10
                                    }}>Перед началом работы обязательно проведите осмотр прибора.</Text>
                                    <Text style={styles.Step}>
                                        Проверьте целостность прибора
                                    </Text>
                                </View>
                                <View>
                                    <Image
                ...
                <Footer>
                    <Left>
                        <Button transparent onPress={() => this.props.navigation.navigate('turningOnB1200')}>
                            <Text>Назад</Text>
                        </Button>
                    </Left>
                    <Body><Button onPress={() => this.props.navigation.navigate('inspectionOfDeviceStep1')}><Text>Шаг 1</Text></Button></Body>
