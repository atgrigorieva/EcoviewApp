    ...
    render(){
        return(
            <Container>
                            ...
                            <View style={{flex:1, flexDirection: 'row'}}>
                                <View style={{
                                    ...
                                    <Text style={{
                                        ...
                                        При каждом включении Спектрофотометр В-1200 ТМ ЭКОВЬЮ проводит самодиагностику
                                        и самокалибровку.
                                    </Text>
                                    <Text style={{
                                        fontSize:15,
                                        ...
                                        Перед работой прибору необходимо прогреться 20 минут.
                                    </Text>
                ...
                <Footer>
                    <Left>
                        <Button transparent onPress={() => this.props.navigation.navigate('SystemInitialization')}>
                            <Text>Назад</Text>
                        </Button>
                    </Left>
                    <Body><Button onPress={() => this.props.navigation.navigate('Lamps')}><Text>Лампы</Text></Button></Body>
