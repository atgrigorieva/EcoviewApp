    ...
    render(){
        return(
            <Container>
                ...
                <Footer>
                    <Left>
                        <Button transparent onPress={() => this.props.navigation.navigate('AutomaticHolder')}>
                            <Text>Назад</Text>
                        </Button>
                    </Left>
                    <Body><Button onPress={() => this.props.navigation.navigate('Pass')}><Text>Пропустить</Text></Button></Body>
