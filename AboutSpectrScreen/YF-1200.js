		...
		return(
			...
			<Container>
				...
				<Content padder >
					<View style={styles.spectr_image}>	
						<Image source={require('../img/YF1200/YF-1800_200.png')} style={styles.image}/>
					</View>
            ...
            <Tabs>
              ...
              <Tab heading={ <TabHeading><Text>Комплект поставки</Text></TabHeading>}>
                ...
                <Footer>
                    <Right><Button onPress={() => this.props.navigation.navigate('Buy', {product:'УФ-1200'})}><Text>КУПИТЬ</Text></Button></Right>
                </Footer>
