			...
			<Container>
				...
				<Content padder >
					<View style={styles.spectr_image}>	
						<Image source={require('../img/YF6100/YF-6100_200.png')} style={styles.image}/>
					</View>
            ...
            <Tabs>
              <Tab heading={ <TabHeading><Text>Технические характеристики</Text></TabHeading>}>
                ...
                <View style={{marginTop:20}}>
                    ...
                    <View style={{flex:1, flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: 'black'}}>
                        <View style={{width:'70%', borderRightWidth: 1, borderRightColor: 'black',
                            borderLeftWidth: 1, borderLeftColor: 'black'}}>
                            <Text>Оптическая схема</Text>
                        </View>
                        <View style={{borderRightWidth: 1, borderRightColor: 'black', width:'30%', verticalAlign:'middle',}}>
                            <Text style={{textAlign: 'center'}}>двухлучевая</Text>
                        </View>
                    </View>
                    <View style={{flex:1, flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: 'black'}}>
                        <View style={{width:'70%', borderRightWidth: 1, borderRightColor: 'black',
                    ...
                    <View style={{flex:1, flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: 'black'}}>
                        ...
                        <View style={{borderRightWidth: 1, borderRightColor: 'black', width:'30%', verticalAlign:'middle',}}>
                            <Text style={{textAlign: 'center'}}>1,8</Text>
                        </View>
                    </View>
                    ...
                    <View style={{flex:1, flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: 'black'}}>
                        ...
                        <View style={{borderRightWidth: 1, borderRightColor: 'black', width:'30%', verticalAlign:'middle',}}>
                            <Text style={{textAlign: 'center'}}>±0,001</Text>
                        </View>
                    </View>
                    ...
                    <View style={{flex:1, flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: 'black'}}>
                        ...
                        <View style={{borderRightWidth: 1, borderRightColor: 'black', width:'30%', verticalAlign:'middle',}}>
                            <Text style={{textAlign: 'center'}}>600×450×200</Text>
                        </View>
                    </View>
                    <View style={{flex:1, flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: 'black'}}>
                        <View style={{width:'70%', borderRightWidth: 1, borderRightColor: 'black',
              ...
              <Tab heading={ <TabHeading><Text>Комплект поставки</Text></TabHeading>}>
                  ...
                  <View style={{marginTop:20}}>
                      ...
                      <Text style={{fontSize:15, fontFamily: 'Arial'}}>    • Кюветодержатель для кювет 10*10 мм 1 шт.</Text>
                ...
                <Footer>
                    <Right><Button onPress={() => this.props.navigation.navigate('Buy', {product:'УФ-6100'})}><Text>КУПИТЬ</Text></Button></Right>
                </Footer>
