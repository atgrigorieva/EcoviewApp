			...
			<Container>
				...
				<Content padder >
					<View style={styles.spectr_image}>	
						<Image source={require('../img/YF1800/YF-1800_200.png')} style={styles.image}/>
					</View>
            ...
            <Tabs>
                ...
                <View style={{marginTop:20}}>
                    <View style={{flex:1, flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: 'black',
                        ...
                        <View style={{borderRightWidth: 1, borderRightColor: 'black', width:'30%', verticalAlign:'middle',}}>
                            <Text style={{textAlign: 'center'}}>от 190 до 1050</Text>
                        </View>
                    </View>
                    <View style={{flex:1, flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: 'black'}}>
                        <View style={{width:'70%', borderRightWidth: 1, borderRightColor: 'black',
                    ...
                    <View style={{flex:1, flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: 'black'}}>
                        ...
                        <View style={{borderRightWidth: 1, borderRightColor: 'black', width:'30%', verticalAlign:'middle',}}>
                            <Text style={{textAlign: 'center'}}>2,0</Text>
                        </View>
                    </View>
              ...
              <Tab heading={ <TabHeading><Text>Комплект поставки</Text></TabHeading>}>
                  ...
                  <View style={{marginTop:20}}>
                      ...
                      <Text style={{fontSize:15, fontFamily: 'Arial'}}>    • Кюветы КУ-1 10 мм. Ширина 24 мм 2 шт..</Text>
                      <Text style={{fontSize:15, fontFamily: 'Arial'}}>    • Кюветы К-8 10 мм. Ширина 24 мм 4 шт.</Text>
                ...
                <Footer>
                    <Right><Button onPress={() => this.props.navigation.navigate('Buy', {product:'УФ-1800'})}><Text>КУПИТЬ</Text></Button></Right>
                </Footer>
