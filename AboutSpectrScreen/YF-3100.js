		...
		return(
			...
			<Container>
				...
				<Content padder >
					<View style={styles.spectr_image}>	
						<Image source={require('../img/YF3100/YF-3000_200.png')} style={styles.image}/>
					</View>
            ...
            <Tabs>
              ...
              <Tab heading={ <TabHeading><Text>Комплект поставки</Text></TabHeading>}>
                ...
                <Footer>
                    <Right><Button onPress={() => this.props.navigation.navigate('Buy', {product:'УФ-3100'})}><Text>КУПИТЬ</Text></Button></Right>
                </Footer>
